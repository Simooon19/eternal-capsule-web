          ...
          {sortedEvents.map((event, index) => (
            <div key={event._key} className="flex-shrink-0 w-64">
              <div className="relative">
                ...
                {/* Timeline dot */}
                <div className="absolute top-6 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-copper-500 rounded-full border-4 border-white dark:border-gray-900 shadow-lg z-10"></div>
    ...
    <div className="timeline-vertical space-y-6">
      {sortedEvents.map((event, index) => (
        <div key={event._key} className="relative flex items-start space-x-4">
          ...
          {/* Timeline dot */}
          <div className="flex-shrink-0 w-8 h-8 bg-copper-500 rounded-full border-4 border-white dark:border-gray-900 shadow-lg z-10"></div>
